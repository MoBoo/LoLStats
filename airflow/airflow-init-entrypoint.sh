...
if [[ -f /sources/variables.json ]]; then
    echo "Importing airflow variables from '/sources/variables.json'"
    airflow variables import /sources/variables.json
fi

if [[ -f /sources/connections.json ]]; then
	echo "Importing airflow variables from '/sources/connections.json'"
    airflow connections import /sources/connections.json
fi
